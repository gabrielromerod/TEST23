...
Google Cloud Platform ofrece máquinas virtuales en 40 regiones en todo el mundo. Cada región de Google Cloud Platform tiene al menos 3 zonas de disponibilidad, lo que permite a los usuarios desplegar aplicaciones en diferentes zonas para garantizar la alta disponibilidad de sus aplicaciones.

A continuación, se presentan las regiones y zonas de disponibilidad de Google Cloud Platform:

1. Oregón (us-west1) - **Bajas Emisiones de CO2**

2. Los Ángeles (us-west2) - **3 Zonas de Disponibilidad**
3. Salt Lake City (us-west3) - **3 Zonas de Disponibilidad** 
4. Las Vegas (us-west4) - **3 Zonas de Disponibilidad**
5. Iowa (us-central1) - **4 Zonas de Disponibilidad, Bajas Emisiones de CO2**
6. Carolina del Sur (us-east1) - **3 Zonas de Disponibilidad**
7. Norte de Virginia (us-east4) - **3 Zonas de Disponibilidad**
8. Columbus (us-east5) - **3 Zonas de Disponibilidad**
9. Dallas (us-south1) - **3 Zonas de Disponibilidad**
10. Montreal (northamerica-northeast1) - **Bajas Emisiones de CO2**
11. Toronto (northamerica-northeast2) - **Bajas Emisiones de CO2**
12. Santiago (southamerica-west1) - **Bajas Emisiones de CO2**
13. São Paulo (southamerica-east1) - **Bajas Emisiones de CO2**
14. Bombay (asia-south1) - **3 Zonas de Disponibilidad**
15. Deli (asia-south2) - **3 Zonas de Disponibilidad**
16. Singapur (asia-southeast1) - **3 Zonas de Disponibilidad**
17. Yakarta (asia-southeast2) - **3 Zonas de Disponibilidad**
18. Hong Kong (asia-east2) - **3 Zonas de Disponibilidad**
19. Taiwán (asia-east1) - **3 Zonas de Disponibilidad**
20. Tokio (asia-northeast1) - **3 Zonas de Disponibilidad**
21. Osaka (asia-northeast2) - **3 Zonas de Disponibilidad**
22. Sídney (australia-southeast1) - **3 Zonas de Disponibilidad**
23. Melbourne (australia-southeast2) - **3 Zonas de Disponibilidad**
24. Seúl (asia-northeast3) - **3 Zonas de Disponibilidad**
25. Tel Aviv (me-west1) - **3 Zonas de Disponibilidad**
26. Doha (me-central1) - **3 Zonas de Disponibilidad**
27. Dammam 7 (me-central2) - **3 Zonas de Disponibilidad**
28. Johannesburgo (africa-south1) - **3 Zonas de Disponibilidad**
29. Londres - **3 Zonas de Disponibilidad**
30. Bélgica - **3 Zonas de Disponibilidad**
31. Países Bajos - **3 Zonas de Disponibilidad**
32. Berlín - **3 Zonas de Disponibilidad**
33. Varsovia - **3 Zonas de Disponibilidad**
34. Frankfurt - **3 Zonas de Disponibilidad**
35. París - **3 Zonas de Disponibilidad**
36. Turín - **3 Zonas de Disponibilidad**
37. Zúrich - **3 Zonas de Disponibilidad** 
38. Milán - **3 Zonas de Disponibilidad**
39. Madrid - **3 Zonas de Disponibilidad**
40. México - **En proceso de llegar a 3 Zonas de Disponibilidad**

#### Amazon Web Services

AWS ofrece una variedad de servicios y recursos de computación en la nube a través de múltiples regiones geográficas distribuidas globalmente. Cada región consta de múltiples zonas de disponibilidad (AZ) diseñadas para ser aisladas entre sí, lo que permite una alta disponibilidad y tolerancia a fallas. Además, AWS también cuenta con ubicaciones de red de borde y cachés de borde regionales para optimizar el rendimiento y la entrega de contenido.

Las ubicaciones de borde en AWS son puntos de presencia distribuidos geográficamente que mejoran el rendimiento de los servicios en la nube. Sirven para reducir la latencia y proporcionar acceso rápido a los datos y contenido. Estas ubicaciones se utilizan para servicios como Amazon CloudFront (red de entrega de contenido), AWS Wavelength (computación de baja latencia para aplicaciones móviles) y AWS Global Accelerator (acceso de red optimizado). También ayudan a entregar contenido estático, aplicaciones web, transmisión de vídeo y otros servicios con mayor eficiencia.
...
| Configuración | CPU   | Memoria RAM | Almacenamiento | Data Out |
|---------------|-------|-------------|----------------|----------|
